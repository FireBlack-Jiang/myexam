 ...
 *
 */
@SuppressLint("NewApi") public class CustomFAB extends ImageButton {
...
*/
	...
	private void init(AttributeSet attrSet) {
	    ...
	    try {
	        setBgColor(arr.getColor(R.styleable.FAB_bg_color, Color.DKGRAY));//表层背景颜色
	        setBgColorPressed(arr.getColor(R.styleable.FAB_bg_color_pressed, Color.GRAY));//按压后的背景颜色
	...
	private void setBgColorPressed(int color) {
