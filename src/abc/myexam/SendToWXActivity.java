...
import abc.myexam.uikit.CameraUtil;
import abc.myexam.uikit.MMAlert;
...
public class SendToWXActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initView();
		findViewById(R.id.send_webpage).performClick();//点击发送网页消息,其余的不用展现
		//findViewById(R.id.send_video).performClick();
	}
	...
	private void initView() {
		...
		findViewById(R.id.send_video).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
							...
							video.videoLowBandUrl = "http://mp.weixin.qq.com/s?__biz=MzIyMTA1MTE4NQ==&mid=401789981&idx=1&sn=513ed2cde8dc6355152e58e06580b7cd#rd";

							WXMediaMessage msg = new WXMediaMessage(video);
							msg.title = "三基本考试(农行人自己的软件)";
							msg.description = "专注农行岗位考试和业务学习，详情可关注微信公众号三基本";
		...
		findViewById(R.id.send_webpage).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {				
							...
							webpage.webpageUrl = "http://mp.weixin.qq.com/s?__biz=MzIyMTA1MTE4NQ==&mid=401789981&idx=1&sn=513ed2cde8dc6355152e58e06580b7cd#rd";
		...
		findViewById(R.id.send_appdata).setVisibility(View.GONE);
		...
		findViewById(R.id.send_emoji).setVisibility(View.GONE);
		// get token
				...
				findViewById(R.id.get_token).setVisibility(View.GONE);
